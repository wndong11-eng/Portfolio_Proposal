...
`assets/img/evidence/` 內 6 張截圖來自舊作品集 PDF，為 Meta 廣告管理員與 Google Analytics 後台畫面。已檢查過**不含品牌名稱、帳戶名稱或任何可識別資訊**，僅有數字欄位。上線前仍建議自行再確認一次是否符合與各品牌的保密約定。
...
資料來源：凱夢月廣告成效簡報（PPTX）、MUMM 月報、HELLOCIK monthly_summary.csv、舊作品集 PDF（過往操作成效.pdf、廣告操作作品集(舊).pdf）
